        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    <input type="date" name="dataemissao" id="dataemissao" class="form-control" value="{{old('dataemissao')}}" required>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
                    <label>Data Prestação</label>
                    <input type="date" name="dataprestacao" id="dataprestacao" class="form-control" value="{{old('dataprestacao')}}" required>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
                    <label>Local Prestação</label>
                    <input type="text" name="localprestacao" id="localprestacao" class="form-control" value="{{old('localprestacao') ?? $prestador->cidade}}" required>
                </div>
            </div>
            <div class="col-sm-1">
                <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="form-group">
                    <label>Ano</label>
                    <input type="text" name="ano" id="ano" class="form-control" value="{{old('ano') ?? $ano}}" maxlength="4" required>
                </div>
            </div>
        </div>
        <!-- fim primeira linha -->
    ...
    <div class="card-body">  
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" name="razaosocial" id="razaosocial" class="form-control" value="{{old('razaosocial') ?? $prestador->razaosocial}}" required>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label>Nome Fantasia</label>
                    <input type="text" name="nomefantasia" id="nomefantasia" class="form-control" value="{{old('nomefantasia') ?? $prestador->nomefantasia}}">
                </div>
            </div>
        </div>
        <!-- fim primeira linha -->
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" name="inscricaomunicipal" id="inscricaomunicipal" class="form-control" value="{{old('inscricaomunicipal') ?? $prestador->inscricaomunicipal}}" required>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label>Inscrição Estadual</label>
                    <input type="text" name="inscricaoestadual" id="inscricaoestadual" class="form-control" value="{{old('inscricaoestadual') ?? $prestador->inscricaoestadual}}">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label>E-mail</label>
                    <input type="email" name="email" id="email" class="form-control" value="{{old('email') ?? $prestador->email}}">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label>Telefone</label>
                    <input type="text" name="telefone" id="telefone" class="form-control" value="{{old('telefone') ?? $prestador->telefone}}">
                </div>
            </div>
        </div>
        <!-- fim segunda linha -->
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label>Rua</label>
                    <input type="text" name="rua" id="rua" size="60" class="form-control" value="{{old('rua') ?? $prestador->rua}}">
                </div>
            </div>
            <div class="col-sm-1">
                <div class="form-group">
                    <label>Número</label>
                    <input type="text" name="numero" id="numero" class="form-control" value="{{old('numero') ?? $prestador->numero}}">
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
                    <label>Bairro</label>
                    <input type="text" name="bairro" id="bairro" size="40" class="form-control" value="{{old('bairro') ?? $prestador->bairro}}">
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
                    <label>Cidade</label>
                    <input type="text" name="cidade" id="cidade" size="40" class="form-control" value="{{old('cidade') ?? $prestador->cidade}}">
                </div>
            </div>
            <div class="col-sm-1">
                <div class="form-group">
                    <label>UF</label>
                    <input type="text" name="uf" id="uf" size="2" class="form-control" value="{{old('uf') ?? $prestador->uf}}">
                </div>
            </div>
        </div>
        <!-- fim terceira linha -->  
